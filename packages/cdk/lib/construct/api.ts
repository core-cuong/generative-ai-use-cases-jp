...
export class Api extends Construct {
  ...
  readonly imageGenerateModelNames: string;
  ...
  constructor(scope: Construct, id: string, props: BackendApiProps) {
    ...
    const modelNames =
      this.node.tryGetContext('modelNames') || 'anthropic.claude-v2';
    const imageGenerateModelNames =
      this.node.tryGetContext('imageGenerateModelNames') ||
    ...
    this.imageGenerateModelNames = imageGenerateModelNames;
